...
ServerEvents.recipes(function (event) {
  ...
  var clocheRecipes = [
    ...
    ["farmersdelight:rice", "farmersdelight:rice_panicle", 1, "farmersdelight:rice_panicles", "immersiveengineering:crop"],
    [
    ...
    //Silent Gear
    ["silentgear:flax_seeds", "supplementaries:flax", 1, "actuallyadditions:flax", "immersiveengineering:crop"],
    ["silentgear:fluffy_seeds", "silentgear:fluffy_puff", 2, "silentgear:fluffy_plant", "immersiveengineering:crop"],

    // Occultism
    ["occultism:datura_seeds", "occultism:datura", 1, "occultism:datura", "immersiveengineering:crop"],

    // Roots
    ["roots:moonglow_seeds", "roots:moonglow", 1, "roots:moonglow_crop", "immersiveengineering:crop"],
    ["roots:spiritleaf_seeds", "roots:spiritleaf", 1, "roots:spiritleaf_crop", "immersiveengineering:crop"],
    ["roots:wildewheet_seeds", "roots:wildewheet", 1, "roots:wildewheet_crop", "immersiveengineering:crop"],
    ["roots:aubergine_seeds", "roots:aubergine", 1, "roots:aubergine_crop", "immersiveengineering:crop"],

    // Enchanted
    ["enchanted:water_artichoke_seeds", "enchanted:water_artichoke", 1, "enchanted:water_artichoke", "immersiveengineering:crop"],
    ["enchanted:belladonna_seeds", "enchanted:belladonna_flower", 1, "enchanted:belladonna", "immersiveengineering:crop"],
    ["enchanted:mandrake_seeds", "enchanted:mandrake_root", 1, "enchanted:mandrake", "immersiveengineering:crop"],
    ["enchanted:snowbell_seeds", "enchanted:icy_needle", 1, "enchanted:snowbell", "immersiveengineering:crop"],
    ["enchanted:wolfsbane_seeds", "enchanted:wolfsbane_flower", 1, "enchanted:wolfsbane", "immersiveengineering:crop"],
